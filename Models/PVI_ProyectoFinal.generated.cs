...
namespace DataModels
{
	...
	/// Data Source    : LaptopMefi\SQLEXPRESS
	...
	public static partial class PviProyectoFinalDBStoredProcedures
	{
		...
		#region SpObtenerCobrosPorCliente

		public static IEnumerable<SpObtenerCobrosPorClienteResult> SpObtenerCobrosPorCliente(this PviProyectoFinalDB dataConnection, int? @idPersona)
		{
			var parameters = new []
			{
				new DataParameter("@id_persona", @idPersona, LinqToDB.DataType.Int32)
			...
			return dataConnection.QueryProc<SpObtenerCobrosPorClienteResult>("[dbo].[SpObtenerCobrosPorCliente]", parameters);
		}

		public partial class SpObtenerCobrosPorClienteResult
		{
			[Column("#Cobro")      ] public int    _Cobro       { get; set; }
			[Column("#Casa")       ] public string _Casa        { get; set; }
			[Column("#Propietario")] public string _Propietario { get; set; }
